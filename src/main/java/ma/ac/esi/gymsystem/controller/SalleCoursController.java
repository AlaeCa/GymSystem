...
public class SalleCoursController {
    ...
    @FXML private TextField    champHoraire;    // format: yyyy-MM-ddTHH:mm
    ...
    public void ajouterSalle() {
        ...
        try {
            ...
            Salle s = new Salle(
                    champNomSalle.getText().trim(),
                    capacite,
                    champDescriptionSalle.getText().trim()
            );
    ...
    public void ajouterCours() {
        if (champNomCours.getText().trim().isEmpty() || champHoraire.getText().trim().isEmpty()
            ...
            labelStatutCours.setText("Tous les champs cours sont obligatoires.");
            return;
        }
        try {
            ...
            labelStatutCours.setText("Erreur format ou DB : " + e.getMessage());
        }
    }
