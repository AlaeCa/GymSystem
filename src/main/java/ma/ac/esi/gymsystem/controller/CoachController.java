...
public class CoachController {
    ...
    public void supprimerCoach() {
        ...
        Alert confirm = new Alert(Alert.AlertType.CONFIRMATION,
                "Supprimer le coach " + selectionne.getPrenom() + " " + selectionne.getNom() + " ?",
    ...
    private boolean validerChamps() {
        ...
        if (!champTelephone.getText().trim().isEmpty() &&
                !Coach.telephoneValide(champTelephone.getText().trim())) {
            labelStatut.setText("Format téléphone invalide (ex: 0612345678).");
            return false;
        }
        return true;
    }
